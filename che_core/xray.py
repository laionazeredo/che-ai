...
from che_core.paths import compute_paths, ensure_session_dirs, get_workspaces_root
...
def main():
    ...
    graphify_ok = 1 if subprocess.run(["command", "-v", "graphify"], shell=True, capture_output=True).returncode == 0 else 0
