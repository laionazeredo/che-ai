...
import sys
import json
from che_core.paths import compute_paths, ensure_session_dirs, get_che_home, get_workspaces_root, _slugify
from che_core.registry import registry_append_jsonl, registry_lookup_last, get_registry_path
...
def main():
    ...
    if args.command == "compute_paths":
        ...
        append_decision_jsonl(args.worktree_root, args.event_type, args.payload, session_id=args.session_id, spec_id=args.spec_id)
