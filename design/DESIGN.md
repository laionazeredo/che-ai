...
version: 1
name: "beta"
created_at: "2026-09-14T20:54:45Z"
...
Sub-product slug: `beta`. Bootstrap timestamp: `2026-09-14T20:54:45Z`. This DESIGN.md is generated from `design/tokens/tokens.json` (single source of truth — see R4 in SPEC `che-design-domain-v1`). Edit `tokens.json` and re-run `che designer tokens render` to keep this file in sync.
