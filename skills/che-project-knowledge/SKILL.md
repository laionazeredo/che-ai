...
[ -n "${CHE_PROJECT_DIR:-}" ] || { echo "[che-project-knowledge] ❌ CHE_PROJECT_DIR não definido. compute_paths falhou?" >&2; exit 99; }
...
che-project-knowledge = humano, lê INTENÇÃO, CONTEXTO DE NEGÓCIO, PESSOAS.
...
updated_by: human (che-project-knowledge interactive)
lang_code: en
lang_docs: en
# ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
...
```
[che-project-knowledge] 📄 Registry atual — <slug>
...
```
> ⚠️ [project knowledge não preenchido] — rode /che-project-knowledge para reduzir ambiguidade do produto.
```
