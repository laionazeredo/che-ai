...
description: Master guide for project management tools. Covers Linear, ClickUp, and Jira integration patterns. Use when the user wants to read, create or updates tickets in Linear.
metadata:
