...
IMMEDIATELY invoke **`harness-scope-checker`** Skill.
...
Relatório: `$HARNESS_WORKSPACE_SHARED/scope-check_<slug>_<YYYYMMDD>.md` com 4 seções canônicas + verdict final 🟢🟡🔴 em PT-BR.
