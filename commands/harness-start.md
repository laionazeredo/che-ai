---
description: "Full harness feature/bug loop: scope capture → TASK GRAPH → dev/qa/compliance → ship. Auto-detects serial vs parallel."
arguments:
  - name: scope
...
IMMEDIATELY invoke the **`harness-scrum-master`** Skill.
